...
// 解析process.argv
const getProcess = (value = [], flag = "PACKAGE_NAME") => {
    const findData = value.find((item) => {
        return item.indexOf(flag) > -1;
    });
    if (!!findData && findData.indexOf("=") > -1) {
        return findData.split("=")[1] || "";
    } else {
        return "";
    }
};
